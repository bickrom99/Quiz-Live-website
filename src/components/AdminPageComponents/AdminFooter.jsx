...
const AdminFooter = () => {
    return (
        <div className="bg-[#FFFEFE] dark:bg-[#111827] w-full ml-auto mt-4 p-4">
            <div className="sm:w-[85%] pr-5 ml-auto">
            <div className="grid sm:grid-cols-5 grid-cols-1 justify-between  py-8 gap-10 sm:pl-0 pl-5">
                <div className="sm:col-span-2">
                    ...
                    <div className="text-[15px] font-roboto font-medium dark:text-[#efefef] ml-2 pb-1">Gmail: <a href="/">liveQuizz@gmail.com</a></div>
                    <div className="text-[15px] font-roboto font-medium ml-2 pb-1 dark:text-[#efefef]">Phone: <a href="/">+8801518993773</a></div>
                    <div className="text-[15px] font-roboto font-medium ml-2 pb-1 dark:text-[#efefef]">Location: Rangpur,Dhaka,Bangladesh</div>
                </div>
                <div className="sm:col-span-1 dark:text-white">
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-white pb-2">Our Service</h3>
                    <ul className="flex flex-col dark:text-[#efefef]">
