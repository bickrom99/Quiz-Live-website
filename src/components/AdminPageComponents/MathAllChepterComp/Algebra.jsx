...
const Algebra = () => {
    const questions = [
        ...
        {
            id: 2,
            question: "What is the sum of the roots of the quadratic equation ax² + bx + c = 0?",
            answer: "-b/a",
        ...
        {
            id: 5,
            question: "What is the value of x in the equation 3x - 7 = 2?",
            answer: "x = 3",
        ...
        <div className="w-[90%] m-auto">
            <div className="grid grid-cols-6 gap-5">
                ...
                <div className="col-span-4 shadow p-4 text-center">
                    <h3 className="text-2xl font-poppins font-medium pt-5">Algebra</h3>
                    <p className="pt-3 font-poppins text-sm font-normal text-[#4c4c4c]">
                        {"Dive into equations and unravel the secrets of variables!"}
                    </p>
